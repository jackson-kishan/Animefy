...
const sidebarItems = [
  ...
  },
  {
    ...
    badge: "2",
    items: [
      { title: "All Anime", url: "/admin/dashboard/animes" },
      { title: "Create Anime", url: "/admin/dashboard/animes/create-anime" },
      { title: "Updates", url: "/admin/dashboard/animes/update-anime", badge: "2" },
      { title: "Installed", url: "#" },
    ],
  },
  {
        ...
        <div className="flex h-full flex-col">
          <div className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold">Designaly</h2>
                <p className="text-xs text-muted-foreground">Creative Suite</p>
              </div>
            </div>
          </div>
