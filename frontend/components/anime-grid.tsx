...
const animeData = [
	{
		...
		episodes: 87,
		summary:
			"Humanity fights for survival against giant humanoid Titans in this epic dark fantasy series.",
	...
	},
	{
		...
		episodes: 1000,
		summary:
			"Follow Monkey D. Luffy and his crew as they search for the ultimate treasure known as One Piece.",
	...
	},
	{
		...
		episodes: 138,
		summary:
			"In a world where most people have superpowers, a powerless boy enrolls in a prestigious hero academy.",
...
export default async function AnimeGrid(animeList: any) {
		...
		<section className="py-16 px-6">
			<div className="container mx-auto">
                ...
                <div className="absolute top-0 left-full ml-4 w-80 bg-gray-800 border border-gray-700 rounded-lg p-4 shadow-2xl z-50 animate-in fade-in-0 slide-in-from-left-2 duration-300">
                  ...
                  <Link href={`/watch/${anime.id}`}>
                    <div className="mt-4 bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors duration-300 flex items-center space-x-2">
